...
relErtPlot = function(model,type,title){
  ...
  print(p3)
  print(p4)
  ggsave(paste0("plots/", type, "_", title, "_1.png"), p1, width = 20, height = 10, units = "cm")
  ggsave(paste0("plots/", type, "_", title, "_2.png"), p2, width = 20, height = 10, units = "cm")
  ggsave(paste0("plots/", type, "_", title, "_3.png"), p3, width = 20, height = 10, units = "cm")
  ggsave(paste0("plots/", type, "_", title, "_4.png"), p4, width = 20, height = 10, units = "cm")
